...
<head>
    ...
    <title>รายละเอียดกลุ่มวิชา</title>
    <link href="https://fonts.googleapis.com/css2?family=Kanit:wght@300&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="../webBPC/headandFooter.css">
    <link rel="stylesheet" href="../webBPC/deGCoures.css">
...
<body>
    <header>
        ...
        <?php
          if(isset($_GET['id'])){
            $id = $_GET["id"];
            $select_posts = "SELECT * FROM tbmajor where ID ='$id'";
        ...
        <div class="container">
            <div class="container-detall">
                ...
                <div class="side">
                    <p><a href="course.php"> หลักสูตรปีพ.ศ. <?php echo" $year";?></a> > <?php echo"กลุ่มวิชา$name";?></p>
                </div>
                
                <!-- end zone -->
                    <div class="data">
                                <h3>รายละเอียด กลุ่มวิชา<?php echo"$name ปี พ.ศ. $year";?></h3><p class='data_content' name=''><?php echo"$text";?></p>
                    </div>
            </div> <!-- end all data -->
