...
<head>
    ...
    <title>รายละเอียดรางวัล</title>
    <link href="https://fonts.googleapis.com/css2?family=Kanit:wght@300&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="../webBPC/headandFooter.css">
    <link rel="stylesheet" href="../webBPC/deAward.css">
    ...
    <header>
           ...
           <a href="home.php"> <img src="../adminBPC/pic/Image 12224.png" alt="" ></a>
            ...
            <ul class="menu">
                ...
                <ul class="dropdown-content">
                    ...
                    <li><a class="active" href="WorkAndAwards.php">ผลงานและรางวัล<br><span>(Work and Awards)</span><div class="border-menu"></div></a></li>
                </ul>
            </li>
        ...
        <div class="container">
            ...
            <div class="border-content-t"></div>
                ...
                if(isset($_GET['id'])){
                    $id=$_GET['id'];
                    $select_posts = "SELECT * FROM tbawar Where ID ='$id'";
            ...
            echo "  <div class='navi'>
            <a href='WorkAndAwards.php'>ผลงานและรางวัล</a> > $rs[Title] </div><br>
                <div class='con_head'>
                    <h2>$rs[Title]</h2>
                ...
                <div class='zoneimgslider'>
                     <div class='mySlides' >
                            <img   src='../adminBPC/upload_award/$rs[Awar_1]' >
                        </div>
                     <div class='mySlides' >
                            <img   src='../adminBPC/upload_award/$rs[Awar_2]' >
                        </div>
                        ...
                        <div class='row'>
                            <div class='column'>
                            <img class='demo cursor' src='../adminBPC/upload_award/$rs[Awar_1]' style='width:100%' onclick='currentSlide(1)' >
                            
                            </div>
                            <div class='column'>
                            <img class='demo cursor' src='../adminBPC/upload_award/$rs[Awar_2]' style='width:100%' onclick='currentSlide(2)' >
